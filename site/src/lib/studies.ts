...
export const studies: Study[] = [
  // ── Industry · applied → "Case Studies" ─────────────────────────────────────
  {
    ...
    title: 'An evolving harness for the era after Fable 5: Building a functional society of agents to enhance AI workflows.',
  ...
  },
  {
    ...
    title: 'Representative democracy in Mexico: shady servers, shady representatives.',
