...
# Real dipMex paths (verified against github.com/emagar/dipMex).
#
# NOTE: the previous `data/votaciones##.csv` / `data/diputados##.csv` paths were
# wrong (HTTP 404). Rosters live under `data/diputados/dip##.csv`. The structured
# individual roll-calls are bundled as `data/votesForWeb/rc{60,61}.csv.zip` (zip of
# dipdat/votdat/rc) and only exist for legislatures 60-61. The full download +
# unpivot + load is handled end-to-end by `scripts/ingest_dipmex.py`; this client
# only fetches the single-file rosters.
DIPMEX_DATASETS: dict[str, str] = {
    "deputies_60": "data/diputados/dip60.csv",
    "deputies_61": "data/diputados/dip61.csv",
    "deputies_64": "data/diputados/dip64.csv",
    "deputies_65": "data/diputados/dip65.csv",
    "deputies_66": "data/diputados/dip66.csv",
}
