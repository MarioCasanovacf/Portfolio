...
> answered with cohort retention, a churn-prediction test from telemetry, and
...
**retention** (cohort), **churn** (does telemetry predict it?), and
...
| Survival / LTV | `pandas` |
| Churn prediction | `scikit-learn` (LogisticRegression, class_weight='balanced') |
| A/B testing | `statsmodels` (proportions_ztest, proportion_confint) |
...
| 02 | `02_Churn_Prediction_Telemetry.ipynb` | Does telemetry predict churn? |
